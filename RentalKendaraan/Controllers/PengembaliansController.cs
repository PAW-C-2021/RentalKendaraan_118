...
namespace RentalKendaraan.Controllers
{
    public class PengembaliansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdPengembalian,TglPembelian,IdPeminjaman,IdKondisi,Denda")] Pengembalian pengembalian)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPengembalian,TglPembelian,IdPeminjaman,IdKondisi,Denda")] Pengembalian pengembalian)
        {
